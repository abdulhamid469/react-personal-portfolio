...
const Projects = () => {
    const projectList = [
        { image:p1, title:"Project One" },
        { image:p5, title:"Project Five" },
    ...
    <div className="w-full px-[23px] bg-[#f6f6f6] relative z-[100]">
        <div className="flex w-full flex-col items-center justify-center gap-10 p-16">
            ...
            <ul className="flex w-full items-center justify-center gap-5 flex-wrap">
                {
                    projectList.map((projects, index:number) => {
                        return (
                            <li key={index} className="md:h-[40vh] h-fit grow" >
                                <img src={projects.image} alt={projects.title} className="max-h-full min-w-full object-cover rounded-md shadow-sm align-bottom"/>
                            </li>
                        )
                    })
                }
